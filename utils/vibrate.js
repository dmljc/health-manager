...
/**
 * 轻震动反馈 - 用于一般点击操作
 * @param {{ type?: 'heavy'|'medium'|'light', silent?: boolean }} [options] 可选配置
 */
 ...
 * @param {number} [duration=400] 震动时长，单位毫秒
 */
 ...
 * @param {'tap'|'click'|'confirm'|'success'|'delete'|'important'|'error'|'warning'} actionType 操作类型
 */
